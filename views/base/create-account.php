...
<html lang="en">
  <head>
    <title>filtro para entrar a principal</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<div class="container">
	...
	*/
	...
	if (mysqli_query($conn, $query)) {
		echo "<div class='alert alert-success mt-4' role='alert'><h3>Excelente ahora Inicia Sesion.</h3>
		<a class='btn btn-outline-success waves-effect' href='index.html' role='button'>Login</a></div>";		
		} else {
