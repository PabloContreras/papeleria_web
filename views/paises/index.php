    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="index">País</a>
              </li>
              <li class="nav-item">
                            ...
                            <form method="POST" action="modify.php?id='.$fila ["id"].'">
                              <div class="modal-body">
                                <div class="col-lg-12">
                                  ...
                                  <div class="form-group">
                                    <label class="form-control-label" for="inputSuccess1">Clima</label>
                                    <input type="text" class="form-control" name="Clima" value="'.$fila ["Clima"].'">
                                  </div>
                                </div>
                              </div>
