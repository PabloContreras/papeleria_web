...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      <a class="navbar-brand" href="../turista/index.php"><i class="fas fa-home"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
          <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="index.php">Videojuegos</a>
              </li>
              <li class="nav-item">
      ...
      <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
        <div class="btn-group" role="group">
            ...
            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
              <a class="dropdown-item" href="../turista/index.php">Perfil</a>
    ...
    <div class="col-lg-10 ml-auto mr-auto mt-5">
      <div class="row justify-content-center">
            ...
            <tbody>
              <?php 
                ...
                while ( $fila = mysqli_fetch_array($registros) ){
                  ...
                  echo '<td><a href="delete.php?id='.$fila ["id"].'"><i class="fas fa-trash-alt" style="color:black;"></i></a></td>';
                  echo '</tr>';   
                  echo  '<div class="modal fade" id="exampleModal'.$fila ["id"].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="modify.php?id='.$fila ["id"].'">
                              <div class="modal-body">
                                <div class="col-lg-12">
                                  ...
                                  <div class="form-group">
                                    <label class="form-control-label" for="inputSuccess1">Precio</label>
                                    <input type="number" class="form-control" name="precio" value="'.$fila ["precio"].'">
                                  </div>
                                  <div class="form-group">
                                    <label class="form-control-label" for="inputSuccess1">Consola</label>
                                    <input type="text" class="form-control" name="consola" value="'.$fila ["consola"].'">
                                  </div>
                                  <div class="form-group">
                                    <label class="form-control-label" for="inputSuccess1">Descripcion</label>
                                    <textarea type="text" class="form-control" name="descripcion">'.$fila ["descripcion"].'</textarea>
                                  </div>
                                </div>
                              </div>
        ...
        <div class="col-lg-2 my-auto">
          <button class="btn btn-success ml-5" data-toggle="modal" data-target="#exampleModal">Agregar</button>
        </div>
      </div>
    </div>
    <!-- Modal -->
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Registrar videojuego</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
              </div>
